...
public class DeleteTodoUseCase {
  ...
  private static final String errorMessage = "DeleteTodoUseCase execute";

  private final TodoDataAccess todoDataAccess;
  private final UserDataAccess userDataAccess;

  public DeleteTodoUseCase(TodoDataAccess todoDataAccess, UserDataAccess userDataAccess) {
