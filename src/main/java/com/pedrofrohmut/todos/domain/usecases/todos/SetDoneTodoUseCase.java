...
public class SetDoneTodoUseCase {

  private static final String errorMessage = "SetDoneTodoUseCase execute";

  private final TodoDataAccess todoDataAccess;
  private final UserDataAccess userDataAccess;

  public SetDoneTodoUseCase(TodoDataAccess todoDataAccess, UserDataAccess userDataAccess) {
  ...
  private void setDoneTodo(String todoId) {
    todoDataAccess.setDone(todoId);
  }
